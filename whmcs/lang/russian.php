...
$_LANG['notificationsnone'] = "На данный момент уведомлений нет.";
...
$_LANG['orderForm']['checkout'] = "Заказать";
...
$_LANG['orderForm']['streetAddress2'] = "Адрес (стр. 2)";
$_LANG['orderForm']['city'] = "Город";
$_LANG['orderForm']['state'] = "Штат";
...
$_LANG['orderForm']['updateTotals'] = "Обновить";
$_LANG['orderForm']['continueShopping'] = "Вернуться в магазин";
